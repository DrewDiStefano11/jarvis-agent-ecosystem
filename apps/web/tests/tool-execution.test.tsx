...
beforeEach(() => { vi.clearAllMocks(); store.tools.executions = []; store.tools.workspaces[0]!.writePrefixes = ['reports']; store.system.emergencyStop = false; store.tools.authorize.mockResolvedValue({ executionId: 'tools-one' }) })
