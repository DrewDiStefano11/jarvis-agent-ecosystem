...
export function Office() {
  ...
  return <>
    ...
    <div className="hub-office-layout"><section className="hub-office-scene" aria-label="Interactive office">
      ...
      <p className="muted">Assign a real identity to a verified station. Security connects to the west walkway through automatic door D42. Other cross-room connections remain under review; one move reserves the aisle until it stops or arrives.</p>
