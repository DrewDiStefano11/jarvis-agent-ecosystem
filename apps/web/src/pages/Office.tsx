...
export function Office() {
  ...
  return <>
    ...
    <div className="hub-office-layout"><section className="hub-office-scene" aria-label="Interactive office">
      <OfficeViewport active document={candidate ? floor : EMPTY_FLOOR} debug={false} reviewMode={candidate} selectedId={selected} hoveredId={hovered} visibleLayers={layers} onSelect={setSelected} onHover={setHovered} onPointerOfficePoint={ignorePointer} onTransformChange={setTransform} focusRequest={focus}/>
