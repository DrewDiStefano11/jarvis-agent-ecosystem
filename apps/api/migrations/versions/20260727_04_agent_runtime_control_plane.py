...
def upgrade():
    op.create_table(
        ...
        sa.Column("parent_run_id", sa.String(120)),
        sa.Column("state", sa.String(40), nullable=False),
        sa.Column("version", sa.Integer, nullable=False),
        sa.Column("event_sequence_number", sa.Integer, nullable=False),
        sa.Column("attempt_count", sa.Integer, nullable=False),
        sa.Column("active_attempt_id", sa.String(120)),
        sa.Column("latest_checkpoint_id", sa.String(120)),
        sa.Column("recovery_status", sa.String(30), nullable=False),
    ...
    for n, c in [
        ("ix_agent_runtime_runs_task_id", "task_id"),
        ("ix_agent_runtime_runs_agent_id", "agent_id"),
        ("ix_agent_runtime_runs_parent_run_id", "parent_run_id"),
        ("ix_agent_runtime_runs_state", "state"),
        ("ix_agent_runtime_runs_created_at", "created_at"),
        ("ix_agent_runtime_runs_deadline", "deadline"),
    ]:
        op.create_index(n, "agent_runtime_runs", [c])
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "run_id",
            sa.String(120),
            sa.ForeignKey("agent_runtime_runs.run_id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("attempt_id", sa.String(120)),
        sa.Column("event_type", sa.String(80), nullable=False),
        sa.Column("schema_version", sa.String(20), nullable=False),
        sa.Column("sequence_number", sa.Integer, nullable=False),
        sa.Column("run_version", sa.Integer, nullable=False),
        sa.Column("timestamp", sa.DateTime(timezone=True), nullable=False),
        sa.Column("actor_reference", sa.String(160)),
...
def downgrade():
    ...
    op.drop_index("ix_agent_runtime_checkpoints_run_id", table_name="agent_runtime_checkpoints")
    ...
    for n in [
        "ix_agent_runtime_runs_deadline",
        "ix_agent_runtime_runs_created_at",
        "ix_agent_runtime_runs_state",
        "ix_agent_runtime_runs_parent_run_id",
        "ix_agent_runtime_runs_agent_id",
        "ix_agent_runtime_runs_task_id",
    ]:
        op.drop_index(n, table_name="agent_runtime_runs")
