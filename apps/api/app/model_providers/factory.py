...
def build_model_router(settings: Settings) -> ModelRouter:
    ...
    return ModelRouter(build_provider_registry(settings), retry)


def build_default_task_budget(settings: Settings) -> TaskBudget:
    return TaskBudget(
        maximum_requests=settings.model_default_maximum_requests,
        maximum_input_tokens=settings.model_default_maximum_input_tokens,
        maximum_output_tokens=settings.model_default_maximum_output_tokens,
