...
class AgentRuntimeRunRow(Base):
    ...
    active_attempt_id: Mapped[str | None] = mapped_column(String(120))
    latest_checkpoint_id: Mapped[str | None] = mapped_column(String(120))
    recovery_status: Mapped[str] = mapped_column(String(30))
...
class AgentRuntimeEventRow(Base):
    ...
    attempt_id: Mapped[str | None] = mapped_column(String(120))
    ...
    __table_args__ = (
        ...
        UniqueConstraint("run_id", "run_version"),
    )
