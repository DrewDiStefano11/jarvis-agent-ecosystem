...
Durably paused runs are also restored on startup. They remain paused at the existing checkpoint and can use the same resume command without repeating committed steps.
